            ...
            <div className='space-y-4 rounded-lg bg-slate-50 p-4'>
              <div className='flex flex-col gap-4 sm:flex-row'>
                ...
                <div className='mx-auto flex-shrink-0 sm:mx-0'>
                  <div className='relative h-32 w-32 overflow-hidden rounded-lg border-2 border-slate-200 bg-white sm:h-24 sm:w-24'>
                    <Image
                    ...
                    className={`relative rounded-lg border-2 p-3 transition-all duration-200 ${
                      selectedSize === size
                        ...
                        : disabled
                          ...
                          : 'hover:border-primary border-slate-200 bg-white hover:shadow-sm'
                    } `}
                  >
